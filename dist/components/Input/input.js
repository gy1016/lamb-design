...
export var Input = function (props) {
    ...
    var cnames = classNames('lamb-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "lamb-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-".concat(icon) }))),
        React.createElement("input", __assign({ className: "lamb-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "lamb-input-group-append" }, append)));
};
