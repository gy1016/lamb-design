...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "lamb-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "lamb-upload-list-item", key: item.uid },
